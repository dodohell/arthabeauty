...
class Speedy {
    ...
    private $username = "999309"; //Афиа Фармаси: "994326" | Афиа Фарма: "994304"; | test: "999309";
    private $password = "3371663797"; //Афиа Фармаси: "4953648964" | Афиа Фарма: "1529841891"; | test: "3371663797";
    ...
    private $sndrContactName = "Смарт Уеб"; // Default contact name of the sender
    private $sndrPhoneNumber = "0884058895"; // Default phone number of the sender
    public $timeZone;
    public $eps;
    ...
    public function getInfo() {
        ...
        $sender->setContactName("Афиа Фарма ЕООД");
    ...
    public function listAllSites($language = "BG", $countryId = 100) {
        
        $resultListAllSites = $this->eps->listAllSites($language, $countryId);
        
        return $resultListAllSites;
    }
    ...
    public function getSiteId($siteName, $regionName, $language = "BG", $countryId = 100) {
        $regionName = $regionName == "София Област" ? "София" : $regionName;
