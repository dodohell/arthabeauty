...
//---------- WorkingTimeSchedule -----------------------------------------------            
            $workingTimeSchedule = $resultListOffices[$k]->getWorkingTimeSchedule();
            ...
            $resultListOfficesArr[$k]["workingTimeSchedule"] = $workingTimeSchedule;
        }
...
//------!!!!!!!!!!!!!!!!!!!--- maxCodBase: 9999.99 ---!!!!!!!!!!!!!!!!!!!!------------------------------------------
        $calculationData->amountCODBase = (float)$amountCODBase < 9999.99 ? (float)$amountCODBase : 9999.99; // Collecton on Delivery amount (25)
