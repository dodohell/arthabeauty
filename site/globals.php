<?php
    ...
    include $install_path . "/payments/eBoricaV2.php";
...
//	}
	$test = 0;
	if ($_SERVER["REMOTE_ADDR"] == "::1" || $_SERVER["REMOTE_ADDR"] == "87.227.188.30"){
        $test = 1;
	}
    $sm->assign("test", $test);
...
//  -------- Google reCAPTCHA ---------------------------------
	...
	$firstpage_brands = Brands::getBrands();
    ...
    $sm->assign("terminal_url", $terminalUrl);
