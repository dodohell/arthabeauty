...
<body>
	...
	<div class="breadcrumbsContainer">
		<div class="container">
			<div class="breadcrubsRow">
				<a href="">Начало</a>
				<span>|</span>
				<a href="">ArthaBeauty Consultant</a> 
			</div>
		</div>
	</div>
	...
	<form class="quizForm">
			...
			<div class="quizContainer">
				<div class="container">
					<div class="radioSection">
						<span class="heading">Отбележете Пол</span>
						<div class="radioRow">
					...
					<div class="radioSection radioSection2">
						<span class="heading">отбележете години</span>
						<div class="radioRow">
							<div class="inputHolder">
								<input type="radio" id="years1" name="years" value="16-20">
								<label for="years1">16-20</label>
							</div>
							<div class="inputHolder">
								<input type="radio" id="years2" name="years" value="21-30">
								<label for="years2">21-30</label>
							</div>
							<div class="inputHolder">
								<input type="radio" id="years3" name="years" value="31-40">
								<label for="years3">31-40</label>
							</div>
							<div class="inputHolder">
								<input type="radio" id="years4" name="years" value="41-50">
								<label for="years4">41-50</label>
							</div>
							<div class="inputHolder">
								<input type="radio" id="years5" name="years" value="50+">
								<label for="years5">50+</label>
							</div>
						</div>
					</div>
					<div class="quizExcerpt">
						Попълни въпросника за всяка от категориите, за които желаеш да получиш съвет от нашите ПРОФЕСИОНАЛНИ консултанти.
					</div>
					<div class="radioSection radioSection3">
						<span class="heading">Изберете категория, за която искате да бъдете консултирани</span>
						<div class="radioRow">
							<div class="inputHolder">
								<input type="radio" id="catyears1" name="catyears" value="16-20">
								<label for="catyears1">16-20</label>
							</div>
							<div class="inputHolder">
								<input type="radio" id="catyears2" name="catyears" value="21-30">
								<label for="catyears2">21-30</label>
							</div>
							<div class="inputHolder">
								<input type="radio" id="catyears3" name="catyears" value="31-40">
								<label for="catyears3">31-40</label>
							</div>
							<div class="inputHolder">
								<input type="radio" id="catyears4" name="catyears" value="41-50">
								<label for="catyears4">41-50</label>
							</div>
							<div class="inputHolder">
								<input type="radio" id="catyears5" name="catyears" value="50+">
								<label for="catyears5">50+</label>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="quizContainer2">
			<div class="container">
				<div class="emailForm">
					<div class="heading">Email, на който да изпратим твоето персонализирано предложение</div>
					<div class="inputHolder">
		...
		<div class="quizContainer3">
			<div class="container">
				<div class="quizSection">
					<div class="heading">Въпрос: Примерен въпрос свързан с козметика?</div>
					<div class="radioRow">
						<div class="inputHolder">
							<input class="optionsInput" type="radio" id="opt1" name="options" value="Опция 1">
							<label class="optionsLabel" for="opt1">Опция 1</label>
						</div>
						<div class="inputHolder">
							<input class="optionsInput" type="radio" id="opt2" name="options" value="Опция 2">
							<label class="optionsLabel" for="opt2">Опция 2</label>
						</div>
						<div class="inputHolder">
							<input class="optionsInput" type="radio" id="opt3" name="options" value="Опция 3">
							<label class="optionsLabel" for="opt3">Опция 3</label>
						</div>
						<div class="inputHolder">
							<input class="optionsInput" type="radio" id="opt4" name="options" value="Опция 4">
							<label class="optionsLabel" for="opt4">Опция 4</label>
						</div>
