			...
			<div class="container">
				<div class="leftColumn">
					...
					<div class="suggested2box">
						<span class="title">Също харесаха</span>
						<div class="slider">
							<div id="suggestedItems" class="itemsRow removeBefore">
								<div class="singleItem">
									<a class="product" href="">
										<div class="imgContainer" style="background-image: url(images/cat-prod1.jpg);"></div>
									</a>
									<div class="info">
										<div class="prodName">Продукт дълго име на два реда</div>
										<div class="starsRow">
										...
										<div class="btnContainer">
											<a class="addBtn" href=""><img src="images/add-to-cart-icon.svg" alt="">Добави</a>
										</div>
									</div>
								</div>
								...
								<div class="singleItem">
									<a class="product" href="">
										<div class="imgContainer" style="background-image: url(images/cat-prod2.jpg);"></div>
									</a>
									<div class="info">
										<div class="prodName">Продукт дълго име на два реда</div>
										<div class="starsRow">
								...
								<div class="singleItem">
									<a class="product" href="">
										<div class="imgContainer" style="background-image: url(images/cat-prod3.jpg);"></div>
									</a>
									<div class="info">
										<div class="prodName">Продукт дълго име на два реда</div>
										<div class="starsRow">
								...
								<div class="singleItem">
									<a class="product" href="">
										<div class="imgContainer" style="background-image: url(images/cat-prod4.jpg);"></div>
									</a>
									<div class="info">
										<div class="prodName">Продукт дълго име на два реда име на два реда</div>
										<div class="starsRow">
											<span class="starBox"><img src="images/star.svg" alt=""></span>
											<span class="starBox"><img src="images/star.svg" alt=""></span>
											<span class="starBox"><img src="images/star.svg" alt=""></span>
								...
								<div class="singleItem">
									<a class="product" href="">
										<div class="imgContainer" style="background-image: url(images/cat-prod5.jpg);"></div>
									</a>
									<div class="info">
										<div class="prodName">Продукт дълго име на два реда</div>
										<div class="starsRow">
					...
					<div class="myCartWrapper">
						<div class="topRow">
							<span class="title">Моята количка</span>
							<span class="subtitle">2 продуктa</span>
						</div>
						<div class="itemsList">
							<ul class="products">
								<li>
									<div class="product">
										...
										<div class="productInfo">
											...
											<span class="prodSubName">Eau de toillete spray</span>
											<span class="prodPrice">80 лв.</span>
											<div class="actionsRow">
												<select class="prodQuantityCart">
													<option></option>
													<option>1</option>
													<option>2</option>
													<option>3</option>
										...
										<div class="deleteBtnCol">
											<span class="delete"><img src="images/icon-x.svg" alt=""></span>
										</div>
									</div>
								</li>
								<li>
								...
								<li>
									<div class="product">
										...
										<div class="productInfo">
											<div class="prodName">Diesel Only The Brave Diesel Only The Brave 50ml</div>
											<span class="prodSubName">Eau de toillete spray</span>
											<span class="prodPrice">80 лв.</span>
											<div class="actionsRow">
												<select class="prodQuantityCart">
					...
					<div class="orderWrapper">
						<div class="order">
							...
							<div class="totalContainer">
								...
								<div class="promoCodeForm">
									<div class="inputField">
										<input type="text" name="promoCode" placeholder="Промо код">
									</div>
									<div class="btnHolder">
							...
							<div class="actionsContainer">
								<a class="orderBtn" href="">Поръчай</a>
								<a class="keepShoppingBtn" href="">продължи с покупките</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="productsRow">
				<div class="singleItem">
					...
					<div class="add2CartHolder">
						<a class="add2CartBtn" href=""><img src="images/add-to-cart-green-icon.svg" alt="">Добави</a>
					</div>
				</div>
				<div class="singleItem">
					<a class="product" href="">
	...
	<script>
		...
		<script>
			...
			$( document ).ready(function() {
				...
				$(".deleteBtnCol .delete").bind("click", function(){
