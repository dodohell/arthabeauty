...
//	
//	if ($website_id){
//		$path_files 		= $_SERVER["DOCUMENT_ROOT"].'/files/websites/'.$website_id.'/';
//		$path_files_tn 		= $_SERVER["DOCUMENT_ROOT"].'/files/websites/'.$website_id.'/tn/';
//		$path_files_tntn 	= $_SERVER["DOCUMENT_ROOT"].'/files/websites/'.$website_id.'/tntn/';
//		
