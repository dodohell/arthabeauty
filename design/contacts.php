		...
		<div class="contactsContainer">
			<div class="container">
				...
				<div class="contactsRow">
					<div class="left">
						<h3 class="title">Моля използвайте тази форма</h3>
						<div class="formContainer">
							<form>
								<div class="inputRow">
									<div class="inputCol12">
										<label for="subject">Тема</label>
										<input id="subject" type="text" name="subject" placeholder="Въведи тема">
									</div>
								</div>
								<div class="inputRow">
									<div class="inputCol6">
										<label for="firstName">Име</label>
										<input id="firstName" type="text" name="fname" placeholder="Въведи име">
									</div>
									<div class="inputCol6">
										<label for="lastName">Фамилия</label>
										<input id="lastName" type="text" name="lname" placeholder="Въведи фамилия">
									</div>
								</div>
								<div class="inputRow">
									<div class="inputCol12">
										<label for="email">Email</label>
										<input id="email" type="text" name="email" placeholder="Въведи email">
									</div>
								</div>
								<div class="inputRow">
									<div class="inputCol12">
										<label>Съобщение</label>
										<textarea class="mesage" placeholder="Въведи съобщение"></textarea>
									</div>
								</div>
								<div class="submitBtnHolder">
									<input class="submitBtn" type="submit" name="submitBtn" value="Изпрати">
								</div>
							</form>
						</div>
					</div>
					<div class="right">
						<h3 class="title">Или се свържете с нас</h3>
						<div class="contactBox">
							<div class="emailImg"></div>
							<div class="content">
								<span class="heading">Имейл:</span>
								<span class="text">support@arthabeauty.com</span>
							</div>
						</div>
						<div class="contactBox">
						...
						<div class="contactBox">
							...
							<div class="content">
								<span class="heading">Работно време:</span>
								<span class="text">Понеделник - Петък 08:00 - 20:00 <br> Събота - Неделя 10:00 - 16:30</span>
							</div>
						</div>
					</div>
				</div>
