...
//	$sm->assign("leftmenu",$leftmenu);
    ...
    $fullmenu = array(
        ...
        array("name" => $configVars["orders"],               "menu_id" => "200", "url" => "#", "icon_class" => "mdi-book-open", "submenu" => array(
        ...
        array("name" => $configVars["catalogue"],               "menu_id" => "300", "url" => "#", "icon_class" => "mdi-book-open", "submenu" => array(
		...
		array("name" => $configVars["administration"],  "menu_id" => "400", "url" => "#", "icon_class" => "mdi-settings", "submenu" => array(
