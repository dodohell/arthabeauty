...
//	$sm->assign("leftmenu",$leftmenu);
    ...
    $fullmenu = array(
        ...
        array("name" => $configVars["orders"],"open" => 3,          "menu_id" => "200", "url" => "#", "icon_class" => "mdi-book-open", "submenu" => array(
                ...
                array("name" => $configVars["products_sales_report"],   "menu_id" => "204", "url" => "products_sales_report.php"),                
            )
        ),
        array("name" => $configVars["catalogue"], "open" => 4,               "menu_id" => "300", "url" => "#", "icon_class" => "mdi-book-open", "submenu" => array(
                array("name" => $configVars["out_of_stock"],        "menu_id" => "317", "url" => "out_of_stock.php"),
...
//                            die();
    ...
    $countNewOrder = Carts::getCountNewOrders();
    $sm->assign("countNewOrder", $countNewOrder);
    
    $countNewCartOrder = Carts::getCountNewCartOrders();
    $sm->assign("countNewCartOrder", $countNewCartOrder);
    
    $countNewFastOrder = Carts::getCountNewFastOrders();
    $sm->assign("countNewFastOrder", $countNewFastOrder);
    
    $products = new Products();
    $countOutOfStockProducts = $products->getOutOfStockProductsCount(1);
    $sm->assign("countOutOfStockProducts", $countOutOfStockProducts["products_count"]);
    ...
    //$test = Helpers::createWebpImages($install_path."files/144439865746376.jpg", $install_path."files/webp/3.webp", 80);
