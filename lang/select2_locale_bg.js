...
(function ($) {
    ...
    $.fn.select2.locales['bg'] = {
        ...
        formatInputTooShort: function (input, min) { var n = min - input.length; return "Моля, започнете да пишете. Резултати ще се появят при въвеждането на още " + n + " символ" + (n > 1 ? "а" : ""); },
