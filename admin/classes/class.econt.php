...
//    private $sndrSiteName = "София"; // Default siteName of the sender (in this case it is София)
    ...
    private $sndrContactName = "АРТХА БЮТИ ЕООД"; // Default contact name of the sender
    private $sndrPhoneNumber = "0885133333"; // Default phone number of the sender
    private $clientNumber = "СФ7447";
    private $ein = "205766567";
    private $molName = "Мишел Коцева";
    private $agentName = "Artha Beauty";
...
//                "instructions" => array(
//                    array(
//                        "name" => "връщането за сметка на получателя"
//                    )
//                )
                ,
                "instructions" => array(
...
//                "paymentReceiverAmountIsPercent" => 0
        ...
        if($senderBringToOffice){
            ...
            //$senderBringToOfficeId = null;
            $request["label"]["senderAddress"] = $senderAddresses[0];
        }
        ...
        if($receiverTakeFromOfficeId){
            ...
            $request["label"]["holidayDeliveryDay"] = "Halfday";
        }
