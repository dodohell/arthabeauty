...
<body>
			...
			<div class="container">
				...
				<div class="articleWrapper">
					<a href="">
						...
						<div class="overlay">
							<h2>Главна Статия</h2>
							<span class="customBtn">Прочети</span>
						</div>
					</a>
				</div>
			</div>
	...
	<div class="newArticlesContainer">
		<div class="container">
			<h3 class="title">Нови Статии</h3>

			<div class="articleRow">
				<article>
					<a href="#">					
						<section class="imgContainer" style="background-image: url(images/article1.jpg);">
							<span class="categoryType1">Категория</span>
						</section>
						<section class="content">
							<h3 class="articleTitle">Много дълго име на статия</h3>
				...
				<article>
					<a href="#">					
						<section class="imgContainer" style="background-image:url(images/article2.jpg)">
				...
				<article>
					<a href="#">					
						<section class="imgContainer" style="background-image:url(images/article3.jpg)">
							<span class="categoryType3">Категория</span>
						</section>
						<section class="content">
							<h3 class="articleTitle">Много дълго име на статия</h3>
							<div class="authorInfo">
				...
				<article>
					<a href="#">					
						<section class="imgContainer" style="background-image:url(images/article4.jpg)">
							<span class="categoryType4">Категория</span>
						</section>
						<section class="content">
							<h3 class="articleTitle">Много дълго име на статия</h3>
							<div class="authorInfo">
	...
	<div class="grayBackgroundContainer">
		
		<div class="importantArticle">
			<div class="container">
				<div class="articleWrapper">
					<a href="">
						<div class="imgContainer" style="background-image: url(images/main-article-2.jpg);"></div>
						<div class="overlay">
							<h2>Статия с акцент</h2>
							<span class="customBtn">Прочети</span>
						</div>
					</a>
				</div>
		...
		<div class="fullWidthArticle">
			<div class="articleWrapper">
				<a href="">
					<div class="imgContainer" style="background-image: url(images/main-article-3.jpg);"></div>
					<div class="overlay">
						<h2>Статия с акцент</h2>
						<span class="customBtn">Прочети</span>
					</div>
